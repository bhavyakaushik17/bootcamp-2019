...
head(gapminder07[order(gapminder07$pop, decreasing = TRUE), ], n = 5)
...
head(gapminder07$lifeExp_round, n = 5)
...
## can also use write_csv

####***************** pro tip: readr is much better *****************
...
hist(gapminder07$lifeExp, main="Distribution of life expectancy across countries in 2007", xlab="Life expectancy", ylab="Frequency", breaks=50)
